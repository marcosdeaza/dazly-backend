...
const serviceAccountPath = path.join(__dirname, 'dazly-api-f81d60806910.json');
...
console.log(`🤖 Vertex AI: Service Account (OAuth)`);
console.log(`🔑 JWT Secret: ${process.env.JWT_SECRET.slice(0, 10)}...`);
